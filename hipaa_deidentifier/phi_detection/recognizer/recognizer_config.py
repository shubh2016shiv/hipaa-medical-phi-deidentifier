...
class MRNConfig:
    ...
    CONTEXT_KEYWORDS = {
        'patient', 'record', 'chart', 'account', 'medical', 
        'mrn', 'admission', 'visit'
    }
...
class DateConfig:
    ...
    DATE_CONTEXT_KEYWORDS = {
        'dob', 'birth', 'born', 'date', 'admission', 
        'discharge', 'visit', 'appointment'
    }
...
class LocationConfig:
    ...
    STREET_TYPES = {
        ...
        'circle', 'cir', 'way', 'parkway', 'pkwy', 'highway', 'hwy'
    }
...
class EncounterConfig:
    ...
    # Context keywords
    ENCOUNTER_KEYWORDS = {
        'encounter', 'visit', 'admission', 'admitted', 'hospitalization',
        'inpatient', 'outpatient', 'ed', 'er', 'emergency'
    }
...
class RecognizerPatterns:
    ...
    US_PHONE_WITH_COUNTRY_CODE = r'(?:\+?1\s*[-\.]?)?\(?\d{3}\)?[-.\s]?\d{3}[-.\s]?\d{4}'
